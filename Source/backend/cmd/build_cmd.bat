...
set "OBJDUMP="
set "STRIP="
set "OUTPUT=cmd_test.exe"
set "TEMP_OUTPUT=cmd_test.build.exe"
set "SOURCE_DIR=..\nes_ace"
set "ENTRY_POINT=cmd_test.cpp"
set "BUILD_LOG=%TEMP%\nes_ace_cmd_build_%RANDOM%_%RANDOM%.log"
set "IMPORT_LOG=%TEMP%\nes_ace_cmd_imports_%RANDOM%_%RANDOM%.log"
set "BUILD_FAILURE="
...
if errorlevel 1 (
	set "BUILD_FAILURE=unable to replace %OUTPUT%; close any running command-line test bed"
	goto :build_failed
)
...
set "NORMALIZED_CXX="
set "PRIMARY_CXX="
set "CXX_VERSION_FILE=%TEMP%\nes_ace_cmd_gcc_%RANDOM%_%RANDOM%.txt"
